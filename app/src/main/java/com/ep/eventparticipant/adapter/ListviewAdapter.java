...
public class ListviewAdapter extends BaseAdapter {
    ...
    private int imageID;
    private List<Informention_item> list;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        final Informention_item informention_item = list.get(position);
        View view = LayoutInflater.from(context).inflate(imageID, parent, false);
        ...
        if (informention_item.getUrl() != null) {
            Glide.with(context).load(informention_item.getUrl()).into(imageView);
        } else {
            Glide.with(context).load(informention_item.getID()).into(imageView);
        }
